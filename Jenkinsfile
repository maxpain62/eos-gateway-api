podTemplate(yaml: readTrusted('pod.yaml')) {
  node(POD_LABEL) {
    ...
    stage ('package helm chart and push aws ecr repository') {
      container('aws-cli-helm') {
        sh """
          helm package eos-gateway-api-chart && ls -l
          helm push eos-gateway-api-0.1.0.tgz oci://134448505602.dkr.ecr.ap-south-1.amazonaws.com/dev/helm/
          aws ecr describe-images --repository-name dev/helm/eos-gateway-api --region ap-south-1
          """
      }
    }
  }
